...
import params.ISBR as p
from src.config import DB
from database.IBSR.data_loader import Loader
...
if __name__ == "__main__":
    ...
    """ DATA LOADING """
    ibsr_db = Loader.create(config_dict=DB.IBSR)
    subject_list = ibsr_db.load_subjects()
    ...
    if params[p.SAMPLING_SCHEME] == 'whole':
        steps_per_epoch = int(len(subject_list_train))
    ...
    cb_learningRateScheduler = ReduceLROnPlateau(factor=0.5, patience=2)
